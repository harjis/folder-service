...
docker build -t d0rka/folder-service-frontend:latest -t d0rka/folder-service-frontend:$SHA -t d0rka/folder-service-frontend:$VERSION -f ./frontend/Dockerfile.dev ./frontend
